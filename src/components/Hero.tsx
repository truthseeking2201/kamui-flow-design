      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-display font-bold text-4xl md:text-5xl lg:text-6xl mb-6 animate-fade-in">
            <span className="text-gradient">AI-Driven</span> Financial <br />
            Market Making
          </h1>
          <p className="text-white/70 text-lg md:text-xl mb-8 md:mb-10 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.1s' }}>
            Revolutionizing liquidity provision with advanced AI agents that optimize your portfolio and automate sophisticated investment strategies
          </p>
